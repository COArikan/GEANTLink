...
wxPAPConfigPanel::wxPAPConfigPanel(const eap::config_provider &prov, eap::config_method_pap &cfg, wxWindow* parent) :
    m_cred(cfg.m_module),
    wxPanel(parent)
{
    ...
    m_credentials = new wxPAPCredentialsPanel(prov, cfg, m_cred, this, true);
